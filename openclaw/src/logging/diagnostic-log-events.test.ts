...
describe("diagnostic log events", () => {
  ...
  it("drops sensitive, blocked, and excess log attribute keys without copying large objects", async () => {
    ...
    structured["REDACTED_HISTORICAL_SECRET1234567890abcdef"] = "secret-key"; // pragma: allowlist secret
    ...
    expect(Object.hasOwn(attributes, "REDACTED_HISTORICAL_SECRET1234567890abcdef")).toBe(false); // pragma: allowlist secret
  });
});
